...
// Clerk's SignUp is locale-aware via unsafeMetadata, which the user.created
// webhook reads to persist the user's locale and send the welcome email in
// the right language. useLocale() is the reason this slice stays client-side
// while the parent page.tsx is a server component (so it can export
